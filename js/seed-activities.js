...
const ACTIVITIES = {
  ...
  'kb-plank-drag': {
    ...
    impactLevel: 'low', logFields: { weight: true, duration: false, distance: false, pace: false }
  },
  'windshield-wipers': {
    id: 'windshield-wipers', name: 'Windshield wipers', category: 'strength-extra',
    primaryMuscles: ['obliques'], secondaryMuscles: ['abs'],
    impactLevel: 'low', logFields: { weight: false, duration: false, distance: false, pace: false }
  },
  dip: {
  ...
  'plate-pinch': {
    ...
    impactLevel: 'low', logFields: { weight: true, duration: true, distance: false, pace: false }
  },
  ...
  'stretch-90-90': {
    ...
    impactLevel: 'low', logFields: { weight: false, duration: true, distance: false, pace: false }
  },
  'stretch-cat-cow': {
  ...
  'pogo-hop': {
    ...
    impactLevel: 'high', logFields: { weight: false, duration: true, distance: false, pace: false }
  },
  'lateral-pogo-hop': {
  ...
  'box-step-off': {
    ...
    impactLevel: 'high', logFields: { weight: false, duration: false, distance: false, pace: false }
  },
  ...
  running: {
    ...
    impactLevel: 'moderate', logFields: { weight: false, duration: true, distance: true, pace: true }
  }
};
